...
Check performed at Mon Dec 17 18:17:51 CST 2018      </nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#UseValueOf"><i class="material-icons warning-icon">warning</i>Should use <code>valueOf</code> instead of <code>new</code> (1)</a>
...
<tr>
<td class="countColumn">1</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
<a href="#UseValueOf">UseValueOf</a>: Should use <code>valueOf</code> instead of <code>new</code></td></tr>
...
<tr><td></td><td class="categoryColumn"><a href="#MissingIssues">Disabled Checks (23)</a>
</td></tr></table>
<br/>              </div>
...
<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerRegistry.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerRegistry.java</a>:16</span>: <span class="message">Use <code>new SparseIntArray(...)</code> instead for better performance</span><br /><pre class="errorlines">
<span class="lineno"> 13 </span><span class="keyword">public</span> <span class="keyword">class</span> RNGestureHandlerRegistry <span class="keyword">implements</span> GestureHandlerRegistry {
<span class="lineno"> 14 </span>
<span class="lineno"> 15 </span>  <span class="keyword">private</span> <span class="keyword">final</span> SparseArray&lt;GestureHandler> mHandlers = <span class="keyword">new</span> SparseArray&lt;>();
<span class="caretline"><span class="lineno"> 16 </span>  <span class="keyword">private</span> <span class="keyword">final</span> SparseArray&lt;Integer> mAttachedTo = <span class="warning"><span class="keyword">new</span> SparseArray&lt;>()</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 17 </span>  <span class="keyword">private</span> <span class="keyword">final</span> SparseArray&lt;ArrayList&lt;GestureHandler>> mHandlersForView = <span class="keyword">new</span> SparseArray&lt;>();
<span class="lineno"> 18 </span>
<span class="lineno"> 19 </span>  <span class="keyword">public</span> <span class="keyword">synchronized</span> <span class="keyword">void</span> registerHandler(GestureHandler handler) {
</pre>
...
Dismiss</button>            </div>
          ...
          </section><a name="UseValueOf"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="UseValueOfCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">Should use valueOf instead of new</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerModule.java">../../src/main/java/com/swmansion/gesturehandler/react/RNGestureHandlerModule.java</a>:610</span>: <span class="message">Use <code>Integer.valueOf(rootViewTag)</code> instead</span><br /><pre class="errorlines">
<span class="lineno"> 607 </span>          <span class="comment">// FIXME: check and warn about gestureHandlerRootHOC</span>
<span class="lineno"> 608 </span>        }
<span class="lineno"> 609 </span>        <span class="keyword">synchronized</span> (mEnqueuedRootViewInit) {
<span class="caretline"><span class="lineno"> 610 </span>          mEnqueuedRootViewInit.remove(<span class="warning"><span class="keyword">new</span> Integer(rootViewTag)</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="metadata"><div class="explanation" id="explanationUseValueOf" style="display: none;">
...
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">UseValueOf</span>
</span>
<span class="mdl-chip">
    <span class="mdl-chip__text">Performance</span>
</span>
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 4/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationUseValueOfLink" onclick="reveal('explanationUseValueOf');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="UseValueOfCardLink" onclick="hideid('UseValueOfCard');">
Dismiss</button>            </div>
            </div>
          </section>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../lib/src/main/java/com/swmansion/gesturehandler/GestureHandlerViewWrapper.java">../../lib/src/main/java/com/swmansion/gesturehandler/GestureHandlerViewWrapper.java</a>:41</span>: <span class="message">Custom view <code>GestureHandlerViewWrapper</code> overrides <code>onTouchEvent</code> but not <code>performClick</code></span><br /><pre class="errorlines">
<span class="lineno"> 38 </span>  }
<span class="lineno"> 39 </span>
<span class="lineno"> 40 </span>  <span class="annotation">@Override</span>
<span class="caretline"><span class="lineno"> 41 </span>  <span class="keyword">public</span> <span class="keyword">boolean</span> <span class="warning">onTouchEvent</span>(MotionEvent event) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 42 </span>    <span class="keyword">return</span> mOrchestrator.onTouchEvent(event);
...
<div class="metadata">Disabled By: Default<br/>
<div class="explanation">
The value of the <code>minSdkVersion</code> property is too low and can be incrementedwithout noticeably reducing the number of supported devices.<br/>Note: This issue has an associated quickfix operation in Android Studio and IntelliJ IDEA.<br>
...
<div class="metadata">Disabled By: Default<br/>
<div class="explanation">
Searches for interprocedural call paths that violate thread annotations in the program. Tracks the flow of instantiated types and lambda expressions to increase accuracy across method boundaries.<br/><div class="moreinfo">More info: <a href="http://developer.android.com/guide/components/processes-and-threads.html#Threads">http://developer.android.com/guide/components/processes-and-threads.html#Threads</a>
